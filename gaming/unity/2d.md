...
![Kdyžtak popis níže](/../../private/Tilemap.jpg)

> [!TIP]
> Výkonnostně je lepší použít Tilemap, pokud máte velké množství objektů, které se opakují.

- Tilemap Renderer, Chunk mode

  Neumožňuje seřazení Tiles na mřížce

- Tilemap Renderer, Individual

  Seřazení Tiles na mřížce

- Sprite Renderer

  Postavy nebo prvky, které se nemohou přizpůsobit mřížce
...
![943f06eea6987f6178e42bd17a92140f55e697b5.png](https://europe1.discourse-cdn.com/unity/original/3X/9/4/943f06eea6987f6178e42bd17a92140f55e697b5.png)
...
Pro více informací <a href="https://www.reddit.com/r/aseprite/comments/vq2mq9/what_size_should_sprites_be_for_a_2d_game/">zde</a>.
...
- Nastavit padding v `TexturePacker` 
  ...
  - **Border padding**
	...
	>[!NOTE]
	> Pomáhá předejít vizuálním artefaktům (nechtěným chybám jako jsou rozmazání nebo barevné okraje) na okrajích `sheetu`.
